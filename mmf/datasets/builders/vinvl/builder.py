...
class VinVLBuilder(MMFDatasetBuilder):
    def __init__(self, dataset_name="vinvl", dataset_class=VinVLDataset, *args, **kwargs):
    ...
    def load(self, config, dataset_type, *args, **kwargs):
        ...
        base_dataset = base_dataset_builder_instance.load_dataset(base_dataset_config, dataset_type)
