...
class BeamSearch(TextDecoder):
    ...
    def init_batch(self, sample_list):
        sample_list = super().init_batch(sample_list)
        # initialize with _batch_size.
    ...
    def decode(self, t, data, scores):
        ...
        for decode_size in self._decode_sizes:
            ...
            if t == 0:
                ...
                top_k_score, top_k_word = scores[ex_start:ex_end].view(-1).topk(
                    decode_size, 0, True, True
                )
        ...
        # TODO: data should include images too ?
