...
# Copy from https://github.com/huggingface/transformers/ modeling_vit.py
# Used for monkey patching previous versions of transformers < 4.5.0
""" PyTorch ViT model. """
...
CONFIG_PATH = "https://huggingface.co/vit-base-patch16-224/resolve/main/config.json"
VIT_PRETRAINED_CONFIG_ARCHIVE_MAP = {
    "nielsr/vit-base-patch16-224": CONFIG_PATH,
    # See all ViT models at https://huggingface.co/models?filter=vit
}
...
# Inspired by
# https://github.com/rwightman/pytorch-image-models/blob/b9bd960a032c7
# 5ca6b808ddeed76bee5f3ed4972/timm/models/layers/helpers.py
...
class ViTSelfOutput(nn.Module):
    """
    The residual connection is defined in ViTLayer instead of here (as is the case with
    other models), due to the
...
class ViTPreTrainedModel(PreTrainedModel):
    ...
    downloading and loading pretrained
    models.
    """
...
class ViTModel(ViTPreTrainedModel):
    ...
    def _prune_heads(self, heads_to_prune):
        ...
        to prune in this layer} See base
