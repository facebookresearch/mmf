...
class IMDBBuilder:
    ...
    def get_args(self):
        ...
        parser.add_argument('-o', "--out_file", type=str, default="./imdb.npy",
                            help="Output file for IMDB")
        parser.add_argument('-i', "--image_root", type=str, default="./COCO",
                            help="Image directory for COCO")
        parser.add_argument('-v', "--version", type=float, default=0.9,
                            help="Visdial version")
        parser.add_argument('-d', "--data_dir", type=str, default="./visdial",
                            help="Directory which contains visdial jsons")
        parser.add_argument('-s', "--set_type", type=str, default="train",
    ...
    def build(self):
        visdial_json_file = os.path.join(self.args.data_dir,
                                         "visdial_%.1f_%s.json" %
                                         (self.args.version,
                                          self.args.set_type))
        data = None
