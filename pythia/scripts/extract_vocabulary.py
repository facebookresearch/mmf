...
class ExtractVocabulary:
    def __init__(self, args):
        ...
        self.vocab_file_name = args.vocab_file_name
    ...
    def extract(self):
        ...
        for inx, question in enumerate(questions):
            words = text_tokenize(question['question'])
        ...
        vocab_file = os.path.join(self.out_dir, vocab_file_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--vocab_file_name", type=str,
                        default="vocabulary.txt", help="Name of the file in "
                        "vocabulary will be stored")

    args = parser.parse_args()
    extractor = ExtractVocabulary(args)
    extractor.extract()
