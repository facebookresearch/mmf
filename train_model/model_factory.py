...
def prepare_model(num_vocab_txt, num_choices, **model_config):
    ...
    for ques_embeding_model in ques_embeding_models_list:
        ...
        tmp_model = build_question_encoding_module(ques_model_key, ques_model_par, num_vocab=num_vocab_txt)
    ...
    for i_image in range(num_image_feat):
        ...
        for image_att_model in image_att_model_list:
            ...
            tmp_img_att_model = build_image_attention_module(image_att_model_par, image_dim=image_feat_dim,
    ...
    classifier = build_classifier(model_config['classifier']['method'], model_config['classifier']['par'],
