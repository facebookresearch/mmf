...
wget https://dl.fbaipublicfiles.com/pythia/val_split/v2_OpenEnded_mscoco_minival2014_questions.json
wget https://dl.fbaipublicfiles.com/pythia/val_split/v2_OpenEnded_mscoco_val2train2014_questions.json
